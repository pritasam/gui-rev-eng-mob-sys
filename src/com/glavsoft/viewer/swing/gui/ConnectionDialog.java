...
public class ConnectionDialog extends JDialog {
	...
	public ConnectionDialog(final JFrame owner, final WindowListener appWindowListener, String serverNameString,
			int serverPort, final OptionsDialog optionsDialog, final ProtocolSettings settings, boolean isApplet) {
		...
		final ConnectionDialog self = this;
		optionsButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				OptionsDialog od = null == optionsDialog ?
						new OptionsDialog(self) :
						optionsDialog;
