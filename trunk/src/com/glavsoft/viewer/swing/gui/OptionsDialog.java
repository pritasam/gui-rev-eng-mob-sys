...
//		JPanel colorDepthPanel = new JPanel(new FlowLayout(FlowLayout.LEFT, 0, 0));
//		colorDepthPanel.setAlignmentX(LEFT_ALIGNMENT);
////		colorDepthPanel.setBorder(
////				BorderFactory.createTitledBorder(
////						BorderFactory.createEtchedBorder(), "Color Depth"));
//		Box box = Box.createVerticalBox();
//		colorDepthPanel.add(box);
//
//		ButtonGroup buttonGroup = new ButtonGroup();
//
//		colorDepthSelected = new RadioButtonSelectedState<Integer>();
//		colorDepthMap = new HashMap<Integer, JRadioButton>();
//
//		addColorDepthRadioButton("Use 24 bit color", ProtocolSettings.BPP_32,
//				colorDepthSelected, colorDepthMap, box, buttonGroup);
//		addColorDepthRadioButton("Use 16 bit color", ProtocolSettings.BPP_16,
//				colorDepthSelected, colorDepthMap, box, buttonGroup);
//		addColorDepthRadioButton("Use 8 bit color", ProtocolSettings.BPP_8,
//				colorDepthSelected, colorDepthMap, box, buttonGroup);
//		addColorDepthRadioButton("Use 6 bit color", ProtocolSettings.BPP_6,
//				colorDepthSelected, colorDepthMap, box, buttonGroup);
//		addColorDepthRadioButton("Use 3 bit color", ProtocolSettings.BPP_3,
//				colorDepthSelected, colorDepthMap, box, buttonGroup);
//		return colorDepthPanel;
	}

//	private void addColorDepthRadioButton(String text, final int state,
//			final RadioButtonSelectedState<Integer> selected,
//			Map<Integer, JRadioButton> state2buttonMap, JComponent component, ButtonGroup group) {
//		addRadioButton(text, state, selected, state2buttonMap, component, group)
//			.addActionListener(new ActionListener() {
//				@Override
//				public void actionPerformed(ActionEvent e) {
//					setEnabled(state <= ProtocolSettings.BPP_8,
//							useJpegQuality);
//					setEnabled(useJpegQuality.isSelected() &&
//							state  <= ProtocolSettings.BPP_8,
//							jpegQuality, jpegQualityPoorLabel, jpegQualityBestLabel);
//				}
//			});
//	}
